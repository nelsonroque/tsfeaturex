...
#' @return Returns the probability of acute change (threshold = 0.70)
#' @export
f.prob.acute.change.7 <- function(x) {
  ...
  ac = ifelse((data.zoo-data.zoo.lag) >= 0.70,1,0)  #this calculates the binary acute change (deals with NA)
