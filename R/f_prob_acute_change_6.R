...
#' @return Returns the probability of acute change (threshold = 0.60)
#' @export
f.prob.acute.change.6 <- function(x) {
  ...
  ac = ifelse((data.zoo-data.zoo.lag) >= 0.60,1,0)  #this calculates the binary acute change (deals with NA)
