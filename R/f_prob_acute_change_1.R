...
#' @return Returns the probability of acute change (threshold = 0.10)
#' @export
f.prob.acute.change.1 <- function(x) {
  ...
  ac = ifelse((data.zoo-data.zoo.lag) >= 0.10,1,0)  #this calculates the binary acute change (deals with NA)
