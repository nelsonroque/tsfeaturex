...
#' @return Returns the probability of acute change (threshold = 0.80)
#' @export
f.prob.acute.change.8 <- function(x) {
  ...
  ac = ifelse((data.zoo-data.zoo.lag) >= 0.80,1,0)  #this calculates the binary acute change (deals with NA)
